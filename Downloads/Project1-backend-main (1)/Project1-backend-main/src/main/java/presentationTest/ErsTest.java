...
//		
		...
		while(itr.hasNext()) {
			...
			System.out.format("%10s %20s %20s %20s\n",
					request.getReqId(), request.getuserId(), request.getReqType(), request.getReqAmount(), request.getSubmitDate(), request.getApproveDate(), request.getManager(), request.getReqStatus());
		}
//		System.out.println("*********************************************************************************************************");
...
//		System.out.println("*********************************************************************************************************");
		...
		newRequest.setuserId(scan.nextInt());
